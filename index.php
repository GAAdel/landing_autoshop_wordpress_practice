            ...
            <div class="flex-center img">
              <div class="container">
                <div class="row">
                  ...
                  <div class="col-7">
                    <img id="img" src="<?php echo get_template_directory_uri()?>/img/1screen-image.png" alt="Автозапчасти" />
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-5 col-12 map-col">
              ...
              <div class="map">
                <script type="text/javascript" charset="utf-8" async src="https://api-maps.yandex.ru/services/constructor/1.0/js/?um=constructor%3A815b2ecf71e981ddd4682ef4b6f1715022f75d666d61ede27fdc0262d202714a&amp;width=100%&amp;height=218&amp;lang=ru_RU&amp;scroll=true"></script>
              </div>
            </div>
          </div>
        </div>
